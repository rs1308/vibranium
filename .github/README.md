...
It is recommended to install Vibranium on a clean Arch Linux installation (e.g. immediately after `archinstall`). Installation on existing long-term systems has not been tested and is not recommended.
...
cd "$HOME/.local/share"
git clone https://github.com/shvedes/vibranium
cd vibranium
./install.sh
```
